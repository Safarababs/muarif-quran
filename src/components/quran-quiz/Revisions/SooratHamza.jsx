...
import SooratHamzaswal from '../Questions/25-June-2023 last 11 soorat/SooratHamza';
...
const SooratHamza = () => {
  ...
  const currentQuestionData = SooratHamzaswal[currentQuestion];
