...
import SooratIFalak from "../Questions/25-June-2023 last 11 soorat/SooratFalak";
...
const SooratFalak = () => {
  ...
  const currentQuestionData = SooratIFalak[currentQuestion];
